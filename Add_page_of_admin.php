...
$sql = "SELECT page_name, display_page FROM admin_access_pages WHERE Status = 'add'";
...
<head>
    ...
    <title>Admin Add Dashboard</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="#">Admin Add Dashboard</a>

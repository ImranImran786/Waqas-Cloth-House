...
// Insert data into staff_access_pages if form is submitted
if (isset($_POST['submit'])) {
    ...
    // Insert query
    $sql = "INSERT INTO staff_access_pages (page_name, display_page, Status) VALUES ('$page_name', '$display_page', '$status')";
...
<head>
    ...
    <title>Assign Pages to Staff</title>
    <style>
...
<body>
    ...
    <!-- Right side for staff_access_pages form -->
    <div class="right">
        <a href="admin_dashboard.html" class="back-button">← Back</a>
        <h2>Assign Pages to Staff</h2>
        <form action="assign_pages_staff_form.php" method="post">
            <div>

...
$sql = "SELECT page_name, display_page FROM manager_access_pages WHERE Status = 'view'";
...
<head>
    ...
    <title>Manager View Dashboard</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="#">Manager View Dashboard</a>

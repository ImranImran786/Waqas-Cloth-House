...
$sql = "SELECT page_name, display_page FROM staff_access_pages WHERE Status = 'view'";
...
<head>
    ...
    <title>Staff View Dashboard</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="#">Staff View Dashboard</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <a href="staff_dashboard.html">Back</a>
    ...
    <div class="container_fluid">
        ...
        if (file_exists($requested_page) && $requested_page !== 'staff_dashboard.php') {
